        ...
        foreach (object processor in (IEnumerable)processors) {
            try {
                try {
                    ...
                    //  Current Voltage
                    ushort i_current_voltage = 0;
                    try { i_current_voltage = (ushort)prop.GetValue(processor, new object[] { "CurrentVoltage" }); }
                    catch { }
                    ...
                    //  Load Percentage 
                    if (processor != null) {
                        ushort load_percentage;
                        object pv = prop.GetValue(processor, new object[] { "LoadPercentage" });
                        if (pv != null)
                            load_percentage = (ushort)pv;
                        else {
                            CpuUsage u = new CpuUsage();
                            load_percentage = (ushort)u.GetUsage();
                        }
