...
namespace Dinamico.Models
{
	...
	public class ContentPage : PageModelBase, IContentPage, IStructuralPage
	{
        ...
        [EditableCheckBox(DefaultValue = true, CheckBoxText = "Display Title", ContainerName = Defaults.Containers.Metadata)]
        ...
        [EditableText(Rows = 20, Columns = 60, TextMode = System.Web.UI.WebControls.TextBoxMode.MultiLine)]
		[DisplayableTokens]
